...
//*************************** Select Class Methods ***************************************//
    ...
    public void selectByContainsTextFromDropDown(WebElement by, String text) {
        List<WebElement> allOptions = new Select(by).getOptions();
        for (WebElement options : allOptions) {
            if (options.getText().contains(text)) {
                options.click();
            }
    ...
    public void selectLastIndexOfDropdownBox(WebElement findBy) {
        Select selectBox = new Select(findBy);
